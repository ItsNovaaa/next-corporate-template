  ...
  },
  {
    ...
    content: {
      overview: {
        ...
        points: ["Investasi panel surya skala utilitas.", "Pengembangan stasiun pengisian EV.", "Produksi Green Hydrogen."]
      },
      milestone: {
        label: "Milestones",
        image: "/1.jpg",
        text: "Langkah strategis dalam membangun portofolio energi masa depan.",
        points: ["2023: Akuisisi ladang surya 500MW.", "2024: Peluncuran stasiun hidrogen pertama.", "2025: Ekspansi ke pasar regional."]
      }
    }
  },
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto">
            Discover our multi-faceted approach through detailed strategic pillars.
          </p>
        </div>
                ...
                <div className="group relative w-full h-[200px] md:h-[250px] rounded-[2rem] overflow-hidden cursor-pointer shadow-lg transition-all hover:scale-[1.01]">
                  ...
                  <div className="absolute inset-0 p-8 md:p-10 flex items-center">
                    <div className="max-w-xl">
                      ...
                      <p className="text-teal-300 font-medium tracking-wide uppercase text-sm mb-4">{item.subtitle}</p>
