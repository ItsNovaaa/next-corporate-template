...
export default function Footer() {
  return (
    // Wrapper utama dengan warna latar belakang hijau tua dari gambar
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-32">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white">Green Power</span>
            </Link>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              <Link href="#" className="bg-black/30 text-xs font-medium px-3 py-1.5 rounded-full hover:bg-black/50 transition-colors">
                REGISTRATION
              </Link>
              <Link href="#" className="bg-black/30 text-xs font-medium px-3 py-1.5 rounded-full hover:bg-black/50 transition-colors">
                CONTACT
